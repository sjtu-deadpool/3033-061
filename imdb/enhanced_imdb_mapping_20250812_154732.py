...
KNOWN_IMDB_IDS = {
    ...
    13: "0113819",    # Mighty Aphrodite (1995) - comedy
    14: "0110877",    # Postino, Il (1994) - drama, romance
    15: "0113862",    # Mr. Holland's Opus (1995) - drama
    16: "0113149",    # French Twist (Gazon maudit) (1995) - comedy, romance
    17: "0116367",    # From Dusk Till Dawn (1996) - action, comedy
    18: "0112445",    # White Balloon, The (1995) - drama
    19: "0112379",    # Antonia's Line (1995) - drama
    20: "0112365",    # Angels and Insects (1995) - drama, romance
    ...
    24: "0113326",    # Rumble in the Bronx (1995) - action, adventure
    25: "0115685",    # Birdcage, The (1996) - comedy
    26: "0112585",    # Brothers McMullen, The (1995) - comedy
    27: "0112442",    # Bad Boys (1995) - action
    28: "0112384",    # Apollo 13 (1995) - action, drama
    29: "0112462",    # Batman Forever (1995) - action, adventure
    30: "0061395",    # Belle de jour (1967) - drama
    31: "0112740",    # Crimson Tide (1995) - drama, thriller
    32: "0109508",    # Crumb (1994) - documentary
    33: "0112851",    # Desperado (1995) - action, romance
    34: "0112887",    # Doom Generation, The (1995) - comedy, drama
    35: "0113114",    # Free Willy 2: The Adventure Home (1995) - adventure, children's
    36: "0113729",    # Mad Love (1995) - drama, romance
    37: "0110620",    # Nadja (1994) - drama
    38: "0113957",    # Net, The (1995) - sci-fi, thriller
    39: "0114558",    # Strange Days (1995) - action, crime
    40: "0114682",    # To Wong Foo, Thanks for Everything! Julie Newmar (1995) - comedy
    41: "0112508",    # Billy Madison (1995) - comedy
    42: "0109445",    # Clerks (1994) - comedy
    43: "0109635",    # Disclosure (1994) - drama, thriller
    44: "0109642",    # Dolores Claiborne (1994) - drama, thriller
    45: "0111797",    # Eat Drink Man Woman (1994) - comedy, drama
    46: "0109759",    # Exotica (1994) - drama
    47: "0109707",    # Ed Wood (1994) - comedy, drama
    48: "0110057",    # Hoop Dreams (1994) - documentary
    49: "0110099",    # I.Q. (1994) - comedy, romance
    50: "0076759",    # Star Wars (1977) - action, adventure
    51: "0110323",    # Legends of the Fall (1994) - drama, romance
    52: "0110428",    # Madness of King George, The (1994) - drama
    53: "0110636",    # Natural Born Killers (1994) - action, thriller
    54: "0114069",    # Outbreak (1995) - action, drama
    55: "0110413",    # Professional, The (1994) - crime, drama
    100: "0116282",    # Fargo (1996) - crime, drama
    101: "0082509",    # Heavy Metal (1981) - action, adventure
    102: "0065421",    # Aristocats, The (1970) - animation, children's
    103: "0115509",    # All Dogs Go to Heaven 2 (1996) - animation, children's
    104: "0114658",    # Theodore Rex (1995) - comedy
    105: "0117608",    # Sgt. Bilko (1996) - comedy
    106: "0116095",    # Diabolique (1996) - drama, thriller
    107: "0117071",    # Moll Flanders (1996) - drama
    108: "0116768",    # Kids in the Hall: Brain Candy (1996) - comedy
    109: "0117128",    # Mystery Science Theater 3000: The Movie (1996) - comedy, sci-fi
    110: "0114048",    # Operation Dumbo Drop (1995) - action, adventure
    111: "0117979",    # Truth About Cats & Dogs, The (1996) - comedy, romance
    112: "0116322",    # Flipper (1996) - adventure, children's
    113: "0113362",    # Horseman on the Roof, The (Hussard sur le toit, Le) (1995) - drama
    114: "0118114",    # Wallace & Gromit: The Best of Aardman Animation (1996) - animation
    115: "0113270",    # Haunted World of Edward D. Wood Jr., The (1995) - documentary
    116: "0112701",    # Cold Comfort Farm (1995) - comedy
    117: "0117500",    # Rock, The (1996) - action, adventure
    118: "0117998",    # Twister (1996) - action, adventure
    119: "0110480",    # Maya Lin: A Strong Clear Vision (1994) - documentary
}
...
IMDB_LIST = [
    ...
    "0113101",  # 3. Four Rooms (1995) - VERIFIED
    "0113161",  # 4. Get Shorty (1995) - VERIFIED
    "0112722",  # 5. Copycat (1995) - VERIFIED
    "0115012",  # 6. Shanghai Triad (Yao a yao yao dao waipo qiao) (1995) - VERIFIED
    "0114746",  # 7. Twelve Monkeys (1995) - VERIFIED
    "0112431",  # 8. Babe (1995) - VERIFIED
    ...
    "0113819",  # 13. Mighty Aphrodite (1995) - VERIFIED
    "0110877",  # 14. Postino, Il (1994) - VERIFIED
    "0113862",  # 15. Mr. Holland's Opus (1995) - VERIFIED
    "0113149",  # 16. French Twist (Gazon maudit) (1995) - VERIFIED
    "0116367",  # 17. From Dusk Till Dawn (1996) - VERIFIED
    "0112445",  # 18. White Balloon, The (1995) - VERIFIED
    "0112379",  # 19. Antonia's Line (1995) - VERIFIED
    "0112365",  # 20. Angels and Insects (1995) - VERIFIED
    "0117110",  # 21. Muppet Treasure Island (1996) - VERIFIED
    "0112573",  # 22. Braveheart (1995) - VERIFIED
    "0075314",  # 23. Taxi Driver (1976) - VERIFIED
    "0113326",  # 24. Rumble in the Bronx (1995) - VERIFIED
    "0115685",  # 25. Birdcage, The (1996) - VERIFIED
    "0112585",  # 26. Brothers McMullen, The (1995) - VERIFIED
    "0112442",  # 27. Bad Boys (1995) - VERIFIED
    "0112384",  # 28. Apollo 13 (1995) - VERIFIED
    "0112462",  # 29. Batman Forever (1995) - VERIFIED
    "0061395",  # 30. Belle de jour (1967) - VERIFIED
    "0112740",  # 31. Crimson Tide (1995) - VERIFIED
    "0109508",  # 32. Crumb (1994) - VERIFIED
    "0112851",  # 33. Desperado (1995) - VERIFIED
    "0112887",  # 34. Doom Generation, The (1995) - VERIFIED
    "0113114",  # 35. Free Willy 2: The Adventure Home (1995) - VERIFIED
    "0113729",  # 36. Mad Love (1995) - VERIFIED
    "0110620",  # 37. Nadja (1994) - VERIFIED
    "0113957",  # 38. Net, The (1995) - VERIFIED
    "0114558",  # 39. Strange Days (1995) - VERIFIED
    "0114682",  # 40. To Wong Foo, Thanks for Everything! Julie Newmar (1995) - VERIFIED
    "0112508",  # 41. Billy Madison (1995) - VERIFIED
    "0109445",  # 42. Clerks (1994) - VERIFIED
    "0109635",  # 43. Disclosure (1994) - VERIFIED
    "0109642",  # 44. Dolores Claiborne (1994) - VERIFIED
    "0111797",  # 45. Eat Drink Man Woman (1994) - VERIFIED
    "0109759",  # 46. Exotica (1994) - VERIFIED
    "0109707",  # 47. Ed Wood (1994) - VERIFIED
    "0110057",  # 48. Hoop Dreams (1994) - VERIFIED
    "0110099",  # 49. I.Q. (1994) - VERIFIED
    "0076759",  # 50. Star Wars (1977) - VERIFIED
    "0110323",  # 51. Legends of the Fall (1994) - VERIFIED
    "0110428",  # 52. Madness of King George, The (1994) - VERIFIED
    "0110636",  # 53. Natural Born Killers (1994) - VERIFIED
    "0114069",  # 54. Outbreak (1995) - VERIFIED
    "0110413",  # 55. Professional, The (1994) - VERIFIED
    ...
    "0116282",  # 100. Fargo (1996) - VERIFIED
    "0082509",  # 101. Heavy Metal (1981) - VERIFIED
    "0065421",  # 102. Aristocats, The (1970) - VERIFIED
    "0115509",  # 103. All Dogs Go to Heaven 2 (1996) - VERIFIED
    "0114658",  # 104. Theodore Rex (1995) - VERIFIED
    "0117608",  # 105. Sgt. Bilko (1996) - VERIFIED
    "0116095",  # 106. Diabolique (1996) - VERIFIED
    "0117071",  # 107. Moll Flanders (1996) - VERIFIED
    "0116768",  # 108. Kids in the Hall: Brain Candy (1996) - VERIFIED
    "0117128",  # 109. Mystery Science Theater 3000: The Movie (1996) - VERIFIED
    "0114048",  # 110. Operation Dumbo Drop (1995) - VERIFIED
    "0117979",  # 111. Truth About Cats & Dogs, The (1996) - VERIFIED
    "0116322",  # 112. Flipper (1996) - VERIFIED
    "0113362",  # 113. Horseman on the Roof, The (Hussard sur le toit, Le) (1995) - VERIFIED
    "0118114",  # 114. Wallace & Gromit: The Best of Aardman Animation (1996) - VERIFIED
    "0113270",  # 115. Haunted World of Edward D. Wood Jr., The (1995) - VERIFIED
    "0112701",  # 116. Cold Comfort Farm (1995) - VERIFIED
    "0117500",  # 117. Rock, The (1996) - VERIFIED
    "0117998",  # 118. Twister (1996) - VERIFIED
    "0110480",  # 119. Maya Lin: A Strong Clear Vision (1994) - VERIFIED
