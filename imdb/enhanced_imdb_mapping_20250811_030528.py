...
IMDB_LIST = [
    ...
    "0109742",  # 46. Exotica (1994) - VERIFIED
    "0109692",  # 47. Ed Wood (1994) - VERIFIED
    "0110007",  # 48. Hoop Dreams (1994) - VERIFIED
    "0110091",  # 49. I.Q. (1994) - VERIFIED
    "0076759",  # 50. Star Wars (1977) - VERIFIED
    "0110323",  # 51. Legends of the Fall (1994) - VERIFIED
    "0110468",  # 52. Madness of King George, The (1994) - VERIFIED
...
if __name__ == "__main__":
    ...
    print(f"Verified IDs: 52")
    print(f"Progress: 3.1%")
